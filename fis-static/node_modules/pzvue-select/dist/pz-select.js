! function(t, e) {
    ...
    return function(t) {
        ...
        var n, o, r = {};
        i(2), n = i(6), o = i(7), t.exports = n || {}, t.exports.__esModule && (t.exports = t.exports.default);
        var p = "function" == typeof t.exports ? t.exports.options || (t.exports.options = {}) : t.exports;
        o && (p.template = o), p.computed || (p.computed = {}), Object.keys(r).forEach(function(t) {
            var e = r[t];
            p.computed[t] = function() {
                return e
            }
        })
    }, function(t, e, i) {
        ...
        t.exports = function() {
            ...
            return t.toString = function() {
                ...
                for (o = 0; o < e.length; o++) {
                    var p = e[o];
                    "number" == typeof p[0] && n[p[0]] || (i && !p[2] ? p[2] = i : i && (p[2] = "(" + p[2] + ") and (" + i + ")"), t.push(p))
                }
            }, t
        }
    }, function(t, e, i) {
        function n(t, e) {
            for (var i = 0; i < t.length; i++) {
                ...
                if (o) {
                    ...
                    for (; r < n.parts.length; r++) o.parts.push(l(n.parts[r], e))
                } else {
                    for (var p = [], r = 0; r < n.parts.length; r++) p.push(l(n.parts[r], e));
                    d[n.id] = {
                        id: n.id,
                        refs: 1,
                        parts: p
        ...
        function o(t) {
            for (var e = [], i = {}, n = 0; n < t.length; n++) {
                ...
                i[r] ? i[r].parts.push(a) : e.push(i[r] = {
                    id: r,
                    parts: [a]
                })
            }
        ...
        function l(t, e) {
            ...
            if (e.singleton) {
                var r = b++;
                i = x || (x = s(e)), n = a.bind(null, i, r, !1), o = a.bind(null, i, r, !0)
        ...
        function a(t, e, i, n) {
            ...
            if (t.styleSheet) t.styleSheet.cssText = v(e, o);
                ...
                var r = document.createTextNode(o),
                    p = t.childNodes;
                p[e] && t.removeChild(p[e]), p.length ? t.insertBefore(r, p[e]) : t.appendChild(r)
            }
        }
        ...
        Object.defineProperty(e, "__esModule", {
            ...
            methods: {
                ...
                optionsClick: function(t) {
                    var e = t.currentTarget,
                        i = e.getAttribute("value");
                    i != this.value && this.change(i), this.text = e.innerHTML, this.value = i, this.text !== this.placeholder ? this.inputValue = " " : this.inputValue = "", this.isshow = !1, this.$emit("input", this.value)
                },
                setValue: function() {
                    for (var t = this.options, e = !1, i = 0, n = t.length; i < n; i++)
                        if (t[i].value === this.default) {
                            this.value = t[i].value, this.text = t[i].text, this.text != this.placeholder && (this.inputValue = " "), e = !0;
                            break
                        }
